...
{
    public partial class frmLugar_Restaurante : Form
    {
        ...
        public frmLugar_Restaurante()
        {
            InitializeComponent();
        }

        private void frmLugar_Restaurante_Load(object sender, EventArgs e)
        {
            btnCargarImagen.BackColor = kombu_Green;
            btnGuardar.BackColor = kombu_Green;
            btnCargarImagen.ForeColor = AclararColor("#dec59e", 0.85);
