...
{
    public partial class frmReservaLugar : Form
    {
        ...
        public frmReservaLugar()
        {
            InitializeComponent();
        }

        private void frmReservaLugar_Load(object sender, EventArgs e)
        {
            btnConsultar.BackColor = kombu_Green;
            btnConsultar.ForeColor = AclararColor("#dec59e", 0.85);
