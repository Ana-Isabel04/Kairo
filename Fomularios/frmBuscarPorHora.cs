...
{
    public partial class frmBuscarPorHora : Form
    {
        ...
        private void frmBuscarPorHora_Load(object sender, EventArgs e)
        {
           
            btnFiltrar.BackColor = pale_copper;
            btnFiltrar.ForeColor= AclararColor("#dec59e", 0.85);
